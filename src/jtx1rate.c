...
static void jtx1_set_gpu_rate(const unsigned long gpu_rate)
{
    ...
    fp[0] = fopen("/sys/kernel/debug/clk/override.gbus/clk_rate", "w");
    ...
    fp[1] = fopen("/sys/kernel/debug/clk/override.gbus/clk_state", "w");
...
static void jtx1_set_emc_rate(const unsigned long emc_rate)
{
    ...
    fp[0] = fopen("/sys/kernel/debug/clk/override.emc/clk_rate", "w");
    ...
    fp[1] = fopen("/sys/kernel/debug/clk/override.emc/clk_state", "w");
